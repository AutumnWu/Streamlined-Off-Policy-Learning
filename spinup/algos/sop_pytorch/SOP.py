...
def sop(env_fn, hidden_sizes=[256, 256], seed=0,
              ...
              polyak=0.995, lr=3e-4, alpha=0, beta=1, sigma=0.3, batch_size=256, start_steps=10000,
    ...
    for t in range(total_steps):
        ...
        if use_one_step_version and replay_buffer.size >= batch_size:
            ...
            get policy loss
            """
            a_tilda, mean_a_tilda, log_std_a_tilda, log_prob_a_tilda, _, _ = policy_net.forward(obs_tensor, fixed_sigma=True, sigma=sigma, deterministic=True, SOP=True, mod1=True, beta=beta)
