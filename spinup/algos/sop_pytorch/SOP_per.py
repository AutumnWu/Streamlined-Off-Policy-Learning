...
from spinup.algos.sop_pytorch.core_per import SegmentTree, SumSegmentTree, MinSegmentTree
import random
import sys
"""
SOP with PER
...
def sop_per(env_fn, hidden_sizes=[256, 256], seed=0,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--exp_name', type=str, default='sop_per')
    ...
    sop_per(lambda: gym.make(args.env), hidden_sizes=[args.hid] * args.l,
