...
def plot_data(data, xaxis='Epoch', value="AverageEpRet", condition="Condition1", smooth=1, no_legend=False, legend_loc='best', color=None, **kwargs):
    if smooth > 1:
        """
...
def make_plots(all_logdirs, legend=None, xaxis=None, values=None, count=False,  
    ...
    for value in values:
        ...
        plot_data(data, xaxis=xaxis, value=value, condition=condition, smooth=smooth, no_legend=no_legend, legend_loc=legend_loc, estimator=estimator, color=color)
        if xlimit > 0:
            plt.xlim(0, xlimit)
